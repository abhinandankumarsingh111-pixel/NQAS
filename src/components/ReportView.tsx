...
function wordHTML(r: ReportData, watermark: string) {
  ...
  <div style="position:relative;">
    ...
    <tr><td><b>Verification Date:</b> ${esc(r.meta.date)}</td><td><b>Coordinator:</b> ${esc(r.meta.coordinatorName)}</td><td><b>Notebooks Sampled:</b> ${r.students.length}</td></tr>${classBandRow}</table>
    <table style="width:100%;border-collapse:collapse;font-size:12px;font-family:Arial,sans-serif;"><thead><tr style="background:#0A3F6B;color:#fff;"><th style="border:1px solid #ccc;padding:6px;text-align:left;">Student</th><th style="border:1px solid #ccc;padding:6px;">Days Since Checked</th><th style="border:1px solid #ccc;padding:6px;">Checking Status</th><th style="border:1px solid #ccc;padding:6px;text-align:left;">Observations</th></tr></thead><tbody>${rows}</tbody></table>${pupilNote}${disputedNote}
    <h3 style="color:#026874;margin:16px 0 4px;">Overall Observation</h3><p style="font-size:13px;line-height:1.6;">${esc(r.finalObservation)}</p>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="report-body">
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "4px 18px", fontSize: 13, marginBottom: 14 }}>
              ...
              <div><b>Verification Date:</b> {r.meta.date}</div><div><b>Coordinator:</b> {r.meta.coordinatorName}</div><div><b>Notebooks Sampled:</b> {r.students.length}</div>
              {r.academic.classBand && <div><b>Class Band:</b> {CLASS_BAND_LABEL[r.academic.classBand]}</div>}
            </div>
            <div className="scroll-x">
              <table className="rt">
                <thead><tr><th>Student</th><th>Days Since Checked</th><th>Checking Status</th><th style={{ textAlign: "left" }}>Observations</th></tr></thead>
            ...
            <h3>Overall Observation</h3><p style={{ margin: "0 0 13px" }}>{r.finalObservation}</p>
